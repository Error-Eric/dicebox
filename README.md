...
This project is based on <github.com/jamessizeland/peer-to-peer>.

Haven't written my README yet. Only added some features (vertical layout).

The following is the original README file and does not represent any work or opinion of the owner of the repo.
